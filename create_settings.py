        ...
        with open("settings.json", "w+") as settings_file:
            ...
            if not settings["user_channels"]:
                ...
                print("The channels designated for your users are: ") + \
                     (str(channel) + ", " for channel in settings["user_channels"][0:-2] +
                      str(settings["user_channels"][-1]))
            if not settings["user_groups"]:
                ...
                print("The groups designated for your users are: ") + \
                     (str(group) + ", " for group in settings["user_groups"][0:-2] +
                      str(settings["user_groups"][-1]))
            if not settings["admin_channels"]:
                ...
                print("The channels designated for your admins are: ") + \
                     (str(channel) + ", " for channel in settings["admin_channels"][0:-2] +
                      str(settings["admin_channels"][-1]))
            if not settings["admin_groups"]:
                ...
                print("The groups designated for your admins are: ") + \
                     (str(group) + ", " for group in settings["admin_groups"][0:-2] +
                      str(settings["admin_groups"][-1]))
